...
public interface ReplyDAO extends JpaRepository<Reply, Integer> {
	...
	@Modifying
	@Query(value="delete Reply where user_num=:user_num and reply_num=:reply_num", nativeQuery=true)
	@Transactional
...
//	public void deleteReplyInMyPost(int post_num);
	...
	@Modifying
	@Query(value="insert into Reply rp(rp.reply_num, rp.post_num, rp.user_num, rp.reply_group, rp.reply_level, rp.reply_step, rp.reply_content) "+ 
			"values(:#{#rp.reply_num}, :#{#rp.board.post_num}, :#{#rp.userinfo.user_num}, :#{#rp.reply_group}, 1, :#{#rp.reply_step}, :#{#rp.reply_content})", nativeQuery=true)
	@Transactional
